...
public class MetaIdGenerator {
    ...
    private static final Logger LOG = LogManager.getLogger(MetaIdGenerator.class);
    ...
    public class IdGeneratorBuffer {
        ...
        private IdGeneratorBuffer(long nextId, long batchEndId) {
            ...
            LOG.info("init buffer: " + nextId + " " + batchEndId);
        }

        public long getNextId() {
            LOG.info("nextId: " + nextId);            
            LOG.info("batchEndId: " + batchEndId);

            Preconditions.checkState(nextId <= batchEndId, "ID: " + nextId + " " + batchEndId);
            return nextId++;
        }
